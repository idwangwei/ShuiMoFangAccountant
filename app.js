...
App({
    ...
    onLaunch: function (shareParam) {
        ...
        if (shareParam.query.userId || shareParam.query.shareUserId || shareParam.query.openId) {
            this.globalData.shareUserId = shareParam.query.userId||shareParam.query.shareUserId|| shareParam.query.openId;
        }
        /**
         * 初次加载判断网络情况
         * 无网络状态下根据实际情况进行调整
    ...
    shareMessage: function (params) {
        return {
            title: params.title || CONFIG.shareProfile,
            path: params.path || `/pages/start/start?shareUserId=${this.globalData.userInfo.openId}`,
